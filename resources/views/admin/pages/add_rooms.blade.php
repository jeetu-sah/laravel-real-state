          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  ...
                  @endif
                    @if ($errors->any())
                      ...
                      @endforeach
                    @endif
                <form method="POST" action="{{ route('admin.rooms.saveRooms') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                 <label>Rooms Area <span class="text-danger">*</span> </label>
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Rooms Area" name="room_area" value="{{ old('room_area') }}" />
                   </div>
                </div>
                <div class="form-group">
                 <label>Plot Size By GAJ<span class="text-danger">*</span> </label>
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Rooms sizze by gaj" name="size_by_gaj" value="{{ old('size_by_gaj') }}" />
                  </div>
                </div>
                <div class="form-group">
                 <label>Plot value</label>
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Plot value" name="plot_value" value="{{ old('plot_value') }}" />
                   </div>
                </div>
                <div class="form-group">
                 <label>Number of plots</label>
                  <div class="input-group">
                    <input type="number" class="form-control" placeholder="Number of plots" name="number_of_plots" id="number_of_plots" value="{{ old('number_of_plots') }}" />
                   </div>
                </div>
                <div class="form-group">
