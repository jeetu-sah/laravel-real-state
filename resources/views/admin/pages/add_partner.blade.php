            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  ...
                  @endif
                    @if ($errors->any())
                      ...
                      @endforeach
                    @endif
                <form method="POST" action="{{ route('admin.add_partners') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                 <label>User ID <span class="text-danger">*</span></label>
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="User ID" name="login_id" id="login_id" />
                   </div>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                 <label>Commission Percentage</label>
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Commission Percentage" name="commission_percentage" />
                   </div>
                </div>
                <div class="form-group">
