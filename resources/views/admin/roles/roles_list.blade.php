  ...
  <div class="content-wrapper">
    ...
    <div class="content header_margin">
    	<div class="container-fluid">
          <div class="row">
          	<div class="col-lg-12">
           	 <a href="{{ url('admin/roles/add_roles') }}" data-toggle="tooltip" title="Add Roles" class="btn btn-primary float-right" style="margin-right: 5px;">
...
$(document).ready(function(e) {
   $('#feature-table').DataTable({
    serverSide: true,
	ajax:"{{ route('admin.roles.roles_list') }}",
    columns: [
